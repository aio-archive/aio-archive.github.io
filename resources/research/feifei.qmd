...
description: By Fei-Fei Li, 2009.03.01
format:
  html: 
    grid:
      body-width: 600px
...
<span style="background:rgba(240, 200, 0, 0.2)">mportant problem (inspiring idea) + solid and novel theory + convincing and analytical experiments + good writing = seminal research + excellent paper</span>
